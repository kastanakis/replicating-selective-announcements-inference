...
if __name__ == '__main__':
    AS_relationships_graph = get_AS_relationships_graph(
        '../__CAIDA_AS-graph__/20230201.as-rel.txt')
    peer = '7018'
    for hour in range(0, 24, 2):
        ...
        if hour < 9:
            ...
            hour = str(hour)
        print(hour)
        routing_table = '../data_collection/output/routing_tables/2023_15_January_AS7018/' + \
            hour + '_routing_table.csv'
        ...
        write_json('sa_prefixes/2023_15_January_AS7018/' +
                   hour + '_sa_prefixes.json', to_write)
